...
Legal Contract Digitizer™ is a backend service that automates the extraction, digitalization, and deployment of legal contracts as Ethereum smart contracts. It leverages AI for clause extraction and Solidity code generation, integrates with the Ethereum blockchain for contract deployment, and manages user wallets securely.
...
└── resources/          # Static resources
   ...
   └── static/
      ├── audio/        # Audio files (e.g. window_minimize.wav)
      ├── images/       # Image assets
...
- Java **17+**, noted that project is build using Java 24
- Maven
...
JWT is issued through Google OAuth2 sign-in.
